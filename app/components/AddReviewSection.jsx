  ...
  return (
    <section>
        <div className="container flex justify-center mt-24 mx-auto px-12 py-4">
            <h1 className="text-4xl font-semibold text-white">Share you experience</h1>
        </div>
        <section className="mx-20 rounded-md drop-shadow-2xl my-10 h-auto"> 
            <form>
                <div className="space-y-12 text-white">
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div className="sm:col-span-4">
                            ...
                            <div className="mt-2">
                                <div className="flex rounded-md px-2 shadow-sm ring-1 ring-gray-300 sm:max-w-md">
                                <input
                                    type="text"
                                    name="username"
                                    id="username"
                                    autoComplete="username"
                                    className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-white placeholder:text-gray-400 sm:text-sm sm:leading-6"
                        ...
                        <div className="sm:col-span-4">
                            ...
                            <div className="mt-2">
                                <div className="flex rounded-md px-2 shadow-sm ring-1 ring-inset ring-gray-300 sm:max-w-md">
                                <input
                                    type="text"
                                    name="email"
                                    id="email"
                        ...
                        <div className="mt-2 flex justify-center rounded-lg border border-dashed border-white px-6 py-10">
                            ...
                            <p className="text-xs leading-5 pt-2 text-gray-200">PNG, JPG, GIF up to 10MB</p>
                            </div>
                        </div>
                        </div>
                    </div>
